...
<hr>
    ...
    <div class="caja_img">
        ...
        <div class="car">
            <div class="car-images">
            <img src="imagenes/Suv/2007 Jeep Wrangler UNLIMITEDX (1).jpeg" title="2007 Jeep Wrangler UNLIMITEDX" alt="2007 Jeep Wrangler UNLIMITEDX">
            <img src="imagenes/Suv/2007 Jeep Wrangler UNLIMITEDX (2).jpeg" title="2007 Jeep Wrangler UNLIMITEDX" alt="2007 Jeep Wrangler UNLIMITEDX">
            <img src="imagenes/Suv/2007 Jeep Wrangler UNLIMITEDX (3).jpeg" title="2007 Jeep Wrangler UNLIMITEDX" alt="2007 Jeep Wrangler UNLIMITEDX">
            <img src="imagenes/Suv/2007 Jeep Wrangler UNLIMITEDX (4).jpeg" title="2007 Jeep Wrangler UNLIMITEDX" alt="2007 Jeep Wrangler UNLIMITEDX">
            <img src="imagenes/Suv/2007 Jeep Wrangler UNLIMITEDX (5).jpeg" title="2007 Jeep Wrangler UNLIMITEDX" alt="2007 Jeep Wrangler UNLIMITEDX">
            <img src="imagenes/Suv/2007 Jeep Wrangler UNLIMITEDX (6).jpeg" title="2007 Jeep Wrangler UNLIMITEDX" alt="2007 Jeep Wrangler UNLIMITEDX">
        </div>
            ...
            <div class="car-info">
                ...
                <h3>2007 Jeep Wrangler</h3>
                <div>
                    <p><b>Miles:</b> 169,811</p>
                    <p><b>Cash:</b> $8.300</p>
                    <button class="more-info-btn" onclick="toggleMoreInfo(this)">Show details &#9660;</button>
                    <div class="more-info">
                    <p><b>Financing:</b>$12.500  (Negotiable)</p> <!-- Garantia incluida-->
                    <p><b>Down:</b> $3.000 (Negotiable)</p>
                </div>
                </div>
                <button onclick="openForm('2007 Jeep Wrangler UNLIMITEDX')">Request Information</button>
            </div>
        </div>
        <!--More suvs here-->
    </div>
